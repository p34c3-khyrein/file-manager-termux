 ...
 * Termux File Manager
 * P34C3_KHYREIN
 * https://github.com/p34c3-khyrein/file-manager-termux
 */
...
//Application Title
define('APP_TITLE', 'Termux File Manager');
...
// highlight.js style
// default 'vs' , for dark theme use 'ir-black'
...
$default_timezone = 'Asia/Jakarta'; // Indonesia
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Termux File Manager">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title">Termux File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Termux File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Termux File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Termux File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based Termux File Manager in PHP, Manage your files efficiently and easily with File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Termux File Manager';    $tr['en']['AppTitle']           = 'Termux File Manager';
